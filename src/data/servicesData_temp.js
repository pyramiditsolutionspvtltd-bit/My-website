// Comprehe    quote: '"From wired networks to wireless innovations, we build secure, scalable and future-ready solutions that help businesses to stay connected anytime, anywhere".',  quote: '"From wired networks to wireless innovations, we build secure, scalable and future-ready solutions that help businesses to stay connected anytime, anywhere".',  quote: '"From wired networks to wireless innovations, we build secure, scalable and future-ready solutions that help businesses to stay connected anytime, anywhere".',  quote: 'From wired networks to wireless innovations, we build secure, scalable and future-ready solutions that help businesses to stay connected anytime, anywhere.',ive IT Services Data
export const servicesData = {
  ...
  'ip-surveillance-cloud': {
    ...
    imageUrl: '../assets/images/services/IP Surveillance.jpg',
    features: [
  ...
  'it-itil-consulting': {
    ...
    quote: 'Optimizing IT operations through proven ITIL best practices and methodologies.',
  ...
  'it-risk-assessment': {
    ...
    fullDescription: 'Thorough IT risk assessment services that identify vulnerabilities, assess potential threats, and provide recommendations to mitigate risks across your IT infrastructure.',
    quote: 'Identifying and mitigating IT risks before they become costly problems.',
  ...
  'it-assessment': {
    ...
    fullDescription: 'Complete IT assessment services that evaluate your current technology infrastructure, identify gaps, and provide strategic recommendations for optimization and modernization.',
    quote: 'Understanding your IT landscape to build a roadmap for success.',
  ...
  'lan-network': {
    ...
    fullDescription: 'Comprehensive LAN solutions providing high-speed, secure connectivity within your organization. Our LAN services ensure optimal network performance and reliability for all your local networking needs.',
    quote: 'Building robust local networks that keep your business connected and productive.',
  ...
  'wlan-network': {
    ...
    fullDescription: 'Advanced WLAN solutions providing secure, high-performance wireless connectivity throughout your organization. Our wireless networks ensure seamless mobility and productivity.',
    quote: 'Enabling mobility and flexibility through advanced wireless networking.',
  ...
  'wan-network': {
    ...
    fullDescription: 'Comprehensive WAN solutions that connect your distributed locations, enable remote access, and provide reliable wide-area connectivity for your organization.',
    quote: 'Connecting distant locations to create one unified, efficient network.',
  ...
  'data-center-network': {
    ...
    fullDescription: 'Advanced data center networking solutions providing high-speed, low-latency connectivity for your critical applications and services with redundancy and scalability.',
    quote: 'Powering your digital infrastructure with enterprise-grade data center networking.',
  ...
  'gpon-network': {
    ...
    fullDescription: 'Gigabit Passive Optical Network (GPON) solutions providing high-speed fiber optic connectivity for broadband, voice, and video services with efficient bandwidth utilization.',
    quote: 'Delivering gigabit speeds through advanced passive optical networking.',
