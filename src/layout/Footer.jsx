                        ...
                        <div className="row">
                            ...
                            <div className="col-lg-4">
                                <div className="rs-footer__info-box">
                                    ...
                                    <div className="content">
                                        <span>Email Us</span>
                                        <Link to="mailto:info@yourname.com">pyramiditsolutionspvtltd@gmail.com</Link>
                                    </div>
                                </div>
                            </div>
                            <div className="col-lg-4">
                        ...
                        <div className="col-lg-3">
                            <div className="rs-footer__navigation rs-footer--navigation">
                                ...
                                <ul>
                                    ...
                                    <li><Link to="/team"><i className="ri-arrow-right-fill" /> Our Team</Link></li>
                                    <li><Link to="/project"><i className="ri-arrow-right-fill" /> Our Projects</Link></li>
                                    <li><Link to="/appointment"><i className="ri-arrow-right-fill" /> Appointment</Link></li>
                                </ul>
                            </div>
                        </div>
                        <div className="col-lg-3">
