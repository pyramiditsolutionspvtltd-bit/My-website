                                ...
                                <>
                                    <div className="col-lg-5">
                                        <div className="rs-footer__copyright-text">
                                           <p>© 2025 Pyramid IT Solutions. Designed By <Link target="_blank" to="https://aptitps.com/">APT IT.</Link></p>
                                        </div>
                                    </div>
                    ...
                    <div className="container">
                        <div className="row">
                            <div className="col-lg-12">
                                <div className="rs-footer__copyright-text">
                                    <p>© 2025 Pyramid IT Solutions. Designed By <Link target="_blank" to="https://www.aptitps.com/">APT IT.</Link></p>
                                </div>
                            </div>
                        </div>
                    </div>
