...
const MenuItems = ({firstLvlMenu, secondLvlMenu}) => {
    ...
    return (
        <>
            ...
            <li className="has-clid relative">
                <Link to="#" className={firstLvlMenu === 'pages' ? "active" : ""}>
                    <cite className="rs_item_wrap">
                        Pages
                        <span className="menu-item-description" title="12"></span>
                    </cite>
                </Link>
                <ul className="sub-menu">
                    <li>
                        <Link to="/our-projects" className={location.pathname === "/our-projects" ? "active" : ""}>Project</Link>
                    </li>
                    <li>
                        <Link to="/project-details" className={location.pathname === "/project-details" ? "active" : ""}>Project Details</Link>
                    </li>
                    <li>
                        <Link to="/our-team" className={location.pathname === "/our-team" ? "active" : ""}>Team</Link>
                    </li>
                    <li>
                        <Link to="/team-details" className={location.pathname === "/team-details" ? "active" : ""}>Team Details</Link>
                    </li>
                    ...
                    <li>
                        <Link to="/appointment" className={location.pathname === "/appointment" ? "active" : ""}>Appointment</Link>
                    </li>
